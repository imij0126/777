...
public class MemberController {
	...
	*/
	 ...
	 *  	  스프링 컨테이너에서 해당 메소드 호출 시 자동으로 객체를 생성해 전달해줌
	 */
	/*
	...
	*/
	 ...
	 *  setter 메소드를 사용해 요청 시 전달 값을 해당 필드에 저장함
	 *  
	...
	public String insertMember(Member m, HttpSession session, Model model) {
		...
		// => 한글 인코딩 처리--> web.xml 파일에 필터를 등록해 처리
		// => 숫자 타입의 데이터(나이,age)가 값이 없을경우 400 에러발생
		//            --> DB 처리 시 자동 형변환 되므로 정수형 -> 문자열 형변환해 처리
